...
delimiter $$
create procedure cursor_1 (in job_name varchar(20))
begin 
...
drop procedure cursor_1;
-- select ename,sal from emp;
call cursor_1('Analyst');
...
if f_name='Snehal' then
select * from emp3 where fname='Snehal';
end if;
until finished
end repeat;
